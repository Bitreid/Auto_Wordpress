...
<header class="header">
  <div class="container">
    ...
    <div class="header__content">
      ...
      <a class="button" id="consult" href="#application">КОНСУЛЬТАЦИЯ ЭКСПЕРТА</a>
      <div class="social header__social">
        <a class="social__link" href="<?php the_field('instagram-link'); ?>">
          <svg class="test" width="26" height="26">
            <use xlink:href="<?php bloginfo('template_url');?>/assests/images/icon/sprite.svg#instagram"></use>
          </svg>
        </a>
        <a class="social__link" href="<?php the_field('telegram-link'); ?>">
          <svg width="25" height="19">
            <use xlink:href="<?php bloginfo('template_url');?>/assests/images/icon/sprite.svg#telegram"></use>
          </svg>
        </a>
        <a class="social__link" href="<?php the_field('whatsapp-link'); ?>">
          <svg width="26" height="26">
            <use xlink:href="<?php bloginfo('template_url');?>/assests/images/icon/sprite.svg#whatsapp"></use>
          </svg>
        </a>
        <a class="social__link" href="<?php the_field('facebook-link'); ?>">
          <svg width="14" height="25">
            <use xlink:href="<?php bloginfo('template_url');?>/assests/images/icon/sprite.svg#facebook"></use>
          </svg>
        </a>
      </div>
      <img data-wow-delay="2s" class="header__images wow animate__fadeInUpBig" src="<?php the_field('top-image') ?>"
        alt="ford mustang">
    </div>
  </div>
</header>
